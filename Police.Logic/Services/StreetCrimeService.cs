...
namespace Police.Logic.Services
{
    public class StreetCrimeService
    {
        ...
        public List<StreetCrimeResponse> GetStreetCrimes(double? lat, double? _long, int? year, int? month)
        {
            var crimes = _searchOutcomesRepository.LookupCrimes(lat, _long, year, month);
